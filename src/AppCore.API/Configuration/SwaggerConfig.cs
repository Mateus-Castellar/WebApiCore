...
public class ConfigureSwaggerOptions : IConfigureOptions<SwaggerGenOptions>
{
    ...
    static OpenApiInfo CreateInfoForApiVersion(ApiVersionDescription description)
    {
        ...
        {
            Title = "API de fornecedores e produtos",
            Version = description.ApiVersion.ToString(),
            Description = "API que realiza crud de fornecedores, endereco e produtos com AspNetIdentity",
...
public static class SwaggerConfig
{
    public static IServiceCollection AddSwaggerConfig(this IServiceCollection services)
    {
        ...
        {
            lbda.OperationFilter<SwaggerDefaultValues>();
    ...
    {
        //app.UseMiddleware<SwaggerAuthorizedMiddleware>(); // => fechar acesso a documentacao!!
        app.UseSwagger();
